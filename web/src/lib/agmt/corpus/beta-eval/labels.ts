...
export const BETA_EVAL_DOCS: BetaEvalDoc[] = [
  {
    ...
    expected: [],
    notes: "Clean traps: defined labels, decimal, URL, email, e.g., Ltd names.",
  },
  {
  ...
  },
  {
    ...
    expected: [],
    notes: "Matching clause reference; no planted mechanical error.",
  },
  {
  ...
  },
  {
    ...
    notes: "Exact unfinished drafting marker.",
  },
  {

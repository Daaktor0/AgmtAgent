# Agmt Proof — invited tester brief

This is an invited testing cohort. The public page at https://app.agmt.legal/proof stays available. Access is not technically restricted.

Proof is not a comprehensive proofreader, grammar checker or legal review. It does not use a language model. Your document is processed on this device and is not sent to Agmt.

## What to do

1. Open https://app.agmt.legal/proof in a current desktop Chromium browser. An account is not required.

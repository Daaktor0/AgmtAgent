"""Value-parsing helpers (dates, money, words-to-number) — plan commit 9.

Moved verbatim from document.py. Both model.py and ingest.py use these; they
depend only on patterns.py, so there is no circular import.
"""

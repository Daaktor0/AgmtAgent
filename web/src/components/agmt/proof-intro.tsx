...
import { PROOF_LOCAL_DEVICE, PROOF_LOCAL_HEADING, PROOF_LOCAL_MAIN, PROOF_LOCAL_NO_ACCOUNT, PROOF_LOCAL_PRIVACY } from "@/lib/proof-local/copy";
...
export function ProofIntro() {
  return (
    <header className="space-y-4">
      ...
      <p className="border-l-2 border-oxblood pl-4 text-sm leading-6">{PROOF_LOCAL_NO_ACCOUNT}</p>
      <p className="text-sm leading-6 text-stone">{PROOF_LOCAL_PRIVACY}</p>

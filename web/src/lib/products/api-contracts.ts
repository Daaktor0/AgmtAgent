...
export const PROOF_UI_COPY: Readonly<Record<ProofUiStateId, { heading: string; main: string }>> = Object.freeze({
  ...
  privacy_before_upload: { heading: "Your file is uploaded only when you start Proof. Files and extracted content are deleted from Agmt-controlled content storage within two hours of upload. You can delete them earlier.", main: "Downloads close five minutes before deletion is due. We retain limited account and operational records, not document content." },
  auth_loading: { heading: "Checking your sign-in…", main: "" },
  signed_out: { heading: "Sign in to upload your document.", main: "" },
  ...
  selected: { heading: "Ready to upload", main: "" },
  wrong_extension: { heading: "Choose a Word (.docx) file containing document text.", main: "" },
  too_large: { heading: "This file exceeds the 25 MiB limit.", main: "" },
  ...
  retry_ineligible: { heading: "This run can’t be retried. Please upload the document again.", main: "" },
  connection_lost: { heading: "We’ve lost the connection. Your uploaded document may still be processing.", main: "" },

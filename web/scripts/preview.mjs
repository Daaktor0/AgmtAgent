...
async function restart() {
  ...
  // Nitro rewrites PGLite's `new URL('pglite.data', import.meta.url)` to
  // `_libs/pglite.data` but does not copy the wasm payload. Deployed apps use
  // Neon (`DATABASE_URL`) and never load PGLite; local `vite preview` does.

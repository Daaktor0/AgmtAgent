...
export const PROOF_LOCAL_SCOPE =
  "Proof checks ordinary-prose spelling with a UK or US dictionary, including quoted sentences of ordinary prose as comments. Quoted defined names and short quoted examples are left alone. A repeated misspelling is still detected; repeated comments are combined onto the first exact span. It also checks a small list of high-confidence typos, repeated function words, repeated punctuation, accidental extra spaces, space before punctuation, missing space after punctuation, unmatched brackets or quotes after looking at neighbouring paragraphs, unfinished placeholders, missing, ambiguous and cross-scope internal references, duplicate clause numbers, duplicate or inconsistent definitions, defined-term capitalisation, party-name consistency, invalid dates and bound words-and-figures mismatches. Missing-reference and undefined-term comments are review questions: a term inherited from another named agreement is not flagged merely because this file omits the definition, and a citation with no matching clause or schedule in the checked text is not presented as a proven drafting error. Headers are checked for tracked typo and punctuation corrections; comments are not placed in headers. Footers, footnotes and endnotes are preserved but not checked. It does not check grammar or meaning.";

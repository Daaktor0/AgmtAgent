...
export const LAUNCH_RULE_SPECS: readonly LaunchRuleSpec[] = Object.freeze([
  ...
  launchSpec({ id: "spelling.dictionary", version: 1, profile: "both", phase: "B", defaultEnabled: true, requiresCapabilities: [], languages: ["en-GB", "en-US"], actionPolicy: "correction", scopeKind: "ordinary_prose", evidenceTier: "bounded-heuristic" }),
